...
public class MindOperatorNetwork {
    ...
    public static void register() {
        MOVEMENTS = NetworkRegistry.newSimpleChannel(SoulCraft.prefix("mind_operator_movements"), () -> VERSION, MindOperatorNetwork::isCorrectVersion, MindOperatorNetwork::isCorrectVersion);
        ...
        ROTATIONS = NetworkRegistry.newSimpleChannel(SoulCraft.prefix("mind_operator_rotations"), () -> VERSION, MindOperatorNetwork::isCorrectVersion, MindOperatorNetwork::isCorrectVersion);
