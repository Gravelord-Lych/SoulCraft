...
public class RecipeDataGen extends ForgeRecipeProvider {
    ...
    private void makeDecayedStoneRelated(ShapedRecipeBuilder builder, String name, BlockItem requiredItem, BlockItem resultItem, Consumer<IFinishedRecipe> consumer) {
        builder.unlockedBy(stHas(name), has(requiredItem)).save(consumer);
    ...
    protected static String stHas(String name) {
        return "has_" + name;
    }

    protected static String stHasTwo(String name1, String name2) {
        return "has_" + name1 + "_and_" + name2;
    }

    protected static ShapedRecipeBuilder create9(IItemProvider result, IItemProvider ingredient) {
        return shaped(result).pattern("###").pattern("###").pattern("###").define('#', ingredient);
    }

    protected static ShapelessRecipeBuilder to9(IItemProvider result, IItemProvider ingredient) {
        return shapeless(result, 9).requires(ingredient);
    }

    protected static ShapedRecipeBuilder makeBricks(IItemProvider result, IItemProvider ingredient) {
        return shaped(result, 4).pattern("##").pattern("##").define('#', ingredient);
    }

    protected static ShapedRecipeBuilder makeChiseled(IItemProvider result, IItemProvider ingredient) {
        return shaped(result).pattern("#").pattern("#").define('#', ingredient);
    }

    protected static ShapedRecipeBuilder makeSlab(IItemProvider result, IItemProvider ingredient) {
        return shaped(result, 6).pattern("###").define('#', ingredient);
    }

    protected static ShapedRecipeBuilder makeStairs(IItemProvider result, IItemProvider ingredient) {
        return shaped(result, 4).pattern("#  ").pattern("## ").pattern("###").define('#', ingredient);
    }

    protected static ShapedRecipeBuilder makeWall(IItemProvider result, IItemProvider ingredient) {
        return shaped(result, 6).pattern("###").pattern("###").define('#', ingredient);
    }

    protected static ShapedRecipeBuilder makeHelmet(IItemProvider result, IItemProvider ingredient) {
        return shaped(result).pattern("XXX").pattern("X X").define('X', ingredient);
    }

    protected static ShapedRecipeBuilder makeChestplate(IItemProvider result, IItemProvider ingredient) {
        return shaped(result).pattern("X X").pattern("XXX").pattern("XXX").define('X', ingredient);
    }

    protected static ShapedRecipeBuilder makeLeggings(IItemProvider result, IItemProvider ingredient) {
        return shaped(result).pattern("XXX").pattern("X X").pattern("X X").define('X', ingredient);
    }

    protected static ShapedRecipeBuilder makeBoots(IItemProvider result, IItemProvider ingredient) {
        return shaped(result).pattern("X X").pattern("X X").define('X', ingredient);
    }

    protected static ShapedRecipeBuilder makeAxe(IItemProvider result, IItemProvider material) {
        return makeAxe(result, material, STICK);
    }

    protected static ShapedRecipeBuilder makeAxe(IItemProvider result, IItemProvider material, IItemProvider stick) {
        return shaped(result).pattern("XX").pattern("X#").pattern(" #").define('#', stick).define('X', material);
    }

    protected static ShapedRecipeBuilder makeHoe(IItemProvider result, IItemProvider material) {
        return makeHoe(result, material, STICK);
    }

    protected static ShapedRecipeBuilder makeHoe(IItemProvider result, IItemProvider material, IItemProvider stick) {
        return shaped(result).pattern("XX").pattern(" #").pattern(" #").define('#', stick).define('X', material);
    }

    protected static ShapedRecipeBuilder makePickaxe(IItemProvider result, IItemProvider material) {
        return makePickaxe(result, material, STICK);
    }

    protected static ShapedRecipeBuilder makePickaxe(IItemProvider result, IItemProvider material, IItemProvider stick) {
        return shaped(result).pattern("XXX").pattern(" # ").pattern(" # ").define('#', stick).define('X', material);
    }

    protected static ShapedRecipeBuilder makeShovel(IItemProvider result, IItemProvider material) {
        return makeShovel(result, material, STICK);
    }

    protected static ShapedRecipeBuilder makeShovel(IItemProvider result, IItemProvider material, IItemProvider stick) {
        return shaped(result).pattern("X").pattern("#").pattern("#").define('#', stick).define('X', material);
    }

    protected static ShapedRecipeBuilder makeSword(IItemProvider result, IItemProvider material) {
        return makeSword(result, material, STICK);
    }

    protected static ShapedRecipeBuilder makeSword(IItemProvider result, IItemProvider material, IItemProvider stick) {
    ...
    protected static CookingRecipeBuilder blasting(IItemProvider result, IItemProvider ingredient, float experience, int cookingTime) {
        return CookingRecipeBuilder.blasting(Ingredient.of(ingredient.asItem()), result, experience, cookingTime);
    }

    protected static CookingRecipeBuilder smoking(IItemProvider result, IItemProvider ingredient, float experience, int cookingTime) {
    ...
    protected static CookingRecipeBuilder campfire(IItemProvider result, IItemProvider ingredient, float experience, int cookingTime) {
    ...
    protected static SingleItemRecipeBuilder stonecutting(IItemProvider result, IItemProvider ingredient) {
        return stonecutting(result, ingredient, 1);
    }

    protected static SingleItemRecipeBuilder stonecutting(IItemProvider result, IItemProvider ingredient, int ingredientCount) {
