...
import lych.soulcraft.client.shader.ModShaderNames;
import lych.soulcraft.util.ModConstants;
import lych.soulcraft.util.data.IDataBuilder;
import lych.soulcraft.util.data.ShaderBuilder;
...
import static lych.soulcraft.util.data.ShaderBuilder.createPassNode;
import static lych.soulcraft.util.data.ShaderBuilder.createUniform;
