...
public final class Reinforcements {
    ...
    static {
        ...
        setBaseEnergyCost(ELDER_GUARDIAN, 2000);
        ...
        setBaseEnergyCost(RAVAGER, 1500);
    ...
    private static void selfCheck() {
        for (Reinforcement reinforcement : REINFORCEMENTS.values()) {
            if (!SE_COST_MAP.containsKey(reinforcement)) {
                SoulCraft.LOGGER.warn(REINFORCEMENT, "Reinforcement of {} has no SE cost, used default value {}", Utils.getRegistryName(reinforcement.getType()), DEFAULT_SE_COST);
            }
        }
    }
...
//        TODO
    ...
    public static void init() {
        SoulCraft.LOGGER.info(REINFORCEMENT, "Initializing reinforcements...");
    }
}
