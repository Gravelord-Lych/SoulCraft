package lych.soulcraft.util.data;
...
public abstract class ChunkGeneratorBuilder implements IDataBuilder {
    private static final ResourceLocation ESV = SoulCraft.prefix(ModDimensionNames.ESV);
    private static final ResourceLocation ETHEREAL = SoulCraft.prefix(ModDimensionNames.ETHEREAL);
