...
import lych.soulcraft.api.event.ArrowSpawnEvent;
...
public class SoulBowItem extends BowItem {
    public static final ResourceLocation PULLING = SoulCraft.prefix("soul_bow_pulling");
    public static final ResourceLocation PULL = SoulCraft.prefix("soul_bow_pull");
