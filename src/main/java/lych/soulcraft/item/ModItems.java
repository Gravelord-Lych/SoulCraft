...
import static lych.soulcraft.block.entity.AbstractSEGeneratorTileEntity.getCapacity;
import static lych.soulcraft.util.ModConstants.VOIDWALKER_SPAWN_EGG_BACKGROUND_COLOR;
...
public final class ModItems {
    ...
    public static final Item ENTITY_CARRIER = new EntityCarrierItem(common(), 1);
    public static final Item ENTITY_CARRIER_II = new EntityCarrierItem(common(), 8);
