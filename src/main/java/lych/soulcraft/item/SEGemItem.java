...
import static lych.soulcraft.api.ItemSEContainer.getMode;
import static lych.soulcraft.api.ItemSEContainer.setMode;

public class SEGemItem extends Item implements ItemSEContainer {
    ...
    public ActionResult<ItemStack> use(World world, PlayerEntity player, Hand hand) {
        if (!world.isClientSide() && hand == Hand.MAIN_HAND && !player.isShiftKeyDown()) {
            ...
            player.sendMessage(new TranslationTextComponent(SoulCraft.prefixMsg("item", "item_soul_energy_container.transfer.set_mode")).append(getMode(stack).makeTranslationKey()), Util.NIL_UUID);
