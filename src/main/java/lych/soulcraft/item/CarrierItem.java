...
import lych.soulcraft.util.DequeNBTOperator;
...
public abstract class CarrierItem<T extends INBT, E> extends Item implements IModeChangeable {
    protected static final String CHANGE_MODE = SoulCraft.prefixMsg("item", "carrier.set_mode");
    protected static final String CAPACITY = SoulCraft.prefixMsg("item", "carrier.capacity");
    ...
    public enum IOMode implements IIdentifiableEnum {
        FIFO(SoulCraft.prefixMsg("item", "carrier.fifo")) {
            @Override
        ...
        LIFO(SoulCraft.prefixMsg("item", "carrier.lifo")) {
            @Override
            public <T extends INBT> void add(CompoundNBT compoundNBT, DequeNBTOperator<T> operator, T nbt) {
        ...
        public static final ITextComponent MODE = new TranslationTextComponent(SoulCraft.prefixMsg("item", "carrier.io_mode"));
