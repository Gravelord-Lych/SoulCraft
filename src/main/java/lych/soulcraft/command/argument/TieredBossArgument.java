...
public class TieredBossArgument extends EntitySummonArgument {
    private static final Collection<String> EXAMPLES = Arrays.asList("soulcraft:giant_x", "soulcraft:skeleton_king");
    private static final DynamicCommandExceptionType NON_TIERED = new DynamicCommandExceptionType(obj -> new TranslationTextComponent(SoulCraft.prefixMsg("commands", "resetboss.non_tiered_boss"), obj));
