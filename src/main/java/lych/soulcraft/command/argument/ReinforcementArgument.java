...
public class ReinforcementArgument implements ArgumentType<Reinforcement> {
    ...
    private static final DynamicCommandExceptionType ERROR_UNKNOWN_REINFORCEMENT = new DynamicCommandExceptionType(rf -> new TranslationTextComponent(SoulCraft.prefixMsg("commands", "reinforcement.reinforcement_not_found"), rf));
