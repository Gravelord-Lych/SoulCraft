package lych.soulcraft.potion;

import lych.soulcraft.SoulCraft;
import lych.soulcraft.effect.ModEffectNames;
...
public final class ModPotions {
    ...
    public static final DeferredRegister<Potion> POTIONS = DeferredRegister.create(ForgeRegistries.POTION_TYPES, SoulCraft.MOD_ID);
    ...
    public static void registerBrewingRecipes() {
        SoulCraft.LOGGER.info(MARKER, "Registering mod brewing recipes...");
    }
}
