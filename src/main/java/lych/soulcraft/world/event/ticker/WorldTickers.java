...
import static lych.soulcraft.world.event.ticker.ContextedWorldTickerType.createAndRegister;
import static lych.soulcraft.world.event.ticker.ContextedWorldTickerType.onRegisterTickers;
...
public class WorldTickers {
    ...
    static {
        TICKERS = new HashSet<>();
        EXPLOSION = createAndRegister(SoulCraft.prefix("explosion"), 20, (ticker, timeRemaining) -> explosion(ticker, false));
        SUMMON_META_08 = createAndRegister(SoulCraft.prefix("summon_meta8"), (ticker, timeRemaining) -> {
