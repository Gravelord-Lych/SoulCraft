package lych.soulcraft.world.spawner;

import com.google.common.collect.Lists;
import lych.soulcraft.SoulCraft;
import lych.soulcraft.util.EntityEventConstants;
...
public abstract class CustomizableSpawner extends AbstractSpawner {
    ...
    public ResourceLocation getEntityId() {
        ...
        try {
            ...
            BlockPos pos = getPos();
            SoulCraft.LOGGER.warn(MARKER, "Invalid entity id '{}' at spawner {}:[{},{},{}]", id, getLevel().dimension().location(), pos.getX(), pos.getY(), pos.getZ());
            return null;
        }
    }
