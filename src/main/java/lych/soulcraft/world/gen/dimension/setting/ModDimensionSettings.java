package lych.soulcraft.world.gen.dimension.setting;

import lych.soulcraft.SoulCraft;
import lych.soulcraft.block.ModBlocks;
import lych.soulcraft.util.data.DimensionSettingsBuilder;
import lych.soulcraft.util.data.NoiseSettingsBuilder;
