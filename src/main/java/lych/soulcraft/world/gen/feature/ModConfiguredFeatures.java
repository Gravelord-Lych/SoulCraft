...
public final class ModConfiguredFeatures {
    ...
    public static final ConfiguredFeature<?, ?> HIGH_SOUL_SAND_SPIKE = ModFeatures.SL_SPIKE.configured(HIGH_SOUL_SAND_SPIKE_CONFIG);
    public static final ConfiguredFeature<?, ?> HIGH_SOUL_SOIL_SPIKE = ModFeatures.SL_SPIKE.configured(HIGH_SOUL_SOIL_SPIKE_CONFIG);
    ...
    public static final ConfiguredFeature<?, ?> SMOOTH_SOUL_STONE_SPIKE = ModFeatures.SL_SPIKE.configured(SMOOTH_SOUL_STONE_SPIKE_CONFIG).decorated(Features.Placements.HEIGHTMAP_SQUARE).count(2);
    public static final ConfiguredFeature<?, ?> SOUL_SAND_SPIKE = ModFeatures.SL_SPIKE.configured(SOUL_SAND_SPIKE_CONFIG).decorated(Features.Placements.HEIGHTMAP_SQUARE).count(2);
    public static final ConfiguredFeature<?, ?> SOUL_SOIL_SPIKE = ModFeatures.SL_SPIKE.configured(SOUL_SOIL_SPIKE_CONFIG).decorated(Features.Placements.HEIGHTMAP_SQUARE).count(2);
    public static final ConfiguredFeature<?, ?> SOUL_STONE_SPIKE = ModFeatures.SL_SPIKE.configured(SOUL_STONE_SPIKE_CONFIG).decorated(Features.Placements.HEIGHTMAP_SQUARE).count(2);
