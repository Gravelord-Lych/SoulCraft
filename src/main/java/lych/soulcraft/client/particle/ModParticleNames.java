...
public final class ModParticleNames {
    public static final String DRIPPING_SOUL_LAVA = "dripping_soul_lava";
    public static final String FALLING_SOUL_LAVA = "falling_soul_lava";
