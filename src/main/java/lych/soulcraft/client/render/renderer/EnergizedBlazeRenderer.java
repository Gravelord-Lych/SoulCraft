...
import lych.soulcraft.entity.monster.boss.EnergizedBlazeEntity;
...
public class EnergizedBlazeRenderer extends MobRenderer<EnergizedBlazeEntity, BlazeModel<EnergizedBlazeEntity>> {
    private static final ResourceLocation ENERGIZED_BLAZE = SoulCraft.prefixTex("entity/energized_blaze.png");
