...
public class Meta08EyesLayer extends DynamicEyesLayer<Meta08Entity, BipedModels.Size64<Meta08Entity>> {
    ...
    public RenderType renderType(Meta08Entity meta8) {
        return RenderType.entityCutout(SoulCraft.prefixTex(String.format("%s_%s_%s.png", EYES, meta8.getPhaseClientSide().name().toLowerCase(), meta8.isAttacking() ? "powered" : "common")));
    }
}
