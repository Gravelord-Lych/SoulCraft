...
public class PursuerRenderer extends EntityRenderer<PursuerEntity> {
    private static final ResourceLocation PURSUER = SoulCraft.prefixTex("entity/esv/pursuer_1.png");
    private static final ResourceLocation PURSUER_TYPE_2 = SoulCraft.prefixTex("entity/esv/pursuer_2.png");
