package lych.soulcraft.client.gui.screen;
...
public class SEStorageScreen extends ContainerScreen<SEStorageContainer> {
    static final ResourceLocation DEFAULT = SoulCraft.prefixTex("gui/container/soul_energy_storage.png");
    static final Map<Integer, ResourceLocation> SE_STORAGE_TEXTURES = Util.make(new HashMap<>(), map -> {
        map.put(1, DEFAULT);
        map.put(2, SoulCraft.prefixTex("gui/container/soul_energy_storage_l2.png"));
        map.put(3, SoulCraft.prefixTex("gui/container/soul_energy_storage_l3.png"));
    });
