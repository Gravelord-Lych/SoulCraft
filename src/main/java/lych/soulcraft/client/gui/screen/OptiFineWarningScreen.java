...
public class OptiFineWarningScreen extends Screen {
    ...
    private static final ITextComponent WARNING = new TranslationTextComponent(SoulCraft.prefixMsg("gui", "optifine_warning"));

    public OptiFineWarningScreen(Screen screen) {
        super(new TranslationTextComponent(SoulCraft.prefixMsg("gui", "optifine_warning_title")));
