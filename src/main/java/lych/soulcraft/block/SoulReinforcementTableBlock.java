...
import lych.soulcraft.gui.container.SoulReinforcementTableContainer;
...
public class SoulReinforcementTableBlock extends Block {
    private static final ITextComponent CONTAINER_TITLE = new TranslationTextComponent(SoulCraft.prefixMsg("gui", "soul_reinforcement_table"));
