...
public final class ModBlocks {
    ...
    public static final Block SOUL_WART = new SoulWartBlock(AbstractBlock.Properties.of(Material.PLANT, MaterialColor.COLOR_CYAN).noCollission().randomTicks().sound(SoundType.NETHER_WART));
