...
import static lych.soulcraft.block.ModBlockStateProperties.IS_GENERATING_SE;
...
public abstract class AbstractSEGeneratorTileEntity extends TileEntity implements ITickableTileEntity, INamedContainerProvider {
    ...
    public ITextComponent getDisplayName() {
        return new TranslationTextComponent(SoulCraft.prefixMsg("gui", getName()) + (getTier() == 1 ? "" : "_l" + getTier()));
    }
