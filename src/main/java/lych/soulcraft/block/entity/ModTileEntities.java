package lych.soulcraft.block.entity;
...
public final class ModTileEntities {
    ...
    public static final TileEntityType<GuiderTileEntity> GUIDER = Builder.of(() -> new GuiderTileEntity(ModTileEntities.GUIDER), ModBlocks.GUIDER).build(null);
    ...
    public static void registerTileEntities(RegistryEvent.Register<TileEntityType<?>> event) {
        ...
        registry.register(make(GUIDER, ModBlockNames.GUIDER));
