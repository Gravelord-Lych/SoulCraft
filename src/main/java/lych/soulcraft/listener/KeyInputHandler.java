...
import lych.soulcraft.network.KeyBindingNetwork;
...
public final class KeyInputHandler {
    ...
    public static void onKeyboardInput(InputEvent.KeyInputEvent event) {
        InvokableManager.getKeyInvokables().keySet().stream()
                ...
                .forEach(invokable -> KeyBindingNetwork.INSTANCE.sendToServer(new KeyBindingNetwork.KeyPacket(invokable.getUUID())));
    }
}
